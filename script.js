function selectableForceDirectedGraph() {
    ...
    function redraw() {
        ...
        xScale.domain(t.rescaleX(xOrigScale).domain());
        yScale.domain(t.rescaleY(yOrigScale).domain());

        vis.attr("transform", t);
    }
    ...
    .on("brush", function() {
        ...
        node.classed("selected", function(d) {
            ...
            (sx[0][0] <= d.x && d.x < sx[1][0]
             && sx[0][1] <= d.y && d.y < sx[1][1]);
        });
    })
    .on("end", function() {
    ...
    center_view = function() {
        ...
        vis.attr("transform",
                 ...
                 svg_graph.call(zoomer.transform, d3.zoomIdentity.scale(min_ratio).translate(x_trans, y_trans));
